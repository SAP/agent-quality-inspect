...
from tool_sandbox.roles.azure_api_agent import (
    GPT_4_1_Agent,
    GPT_4_o_Agent,
    GPT_4_o_mini_Agent,
    GPT_5_Agent,
    Mistral_Nemo_Agent,
    Mistral_Large_2411_Agent
)
...
from tool_sandbox.roles.azure_api_user import (
    GPT_4_1_User,
    GPT_4_o_User,
    GPT_4_o_mini_User,
    GPT_5_User,
    Mistral_Nemo_User,
    Mistral_Large_2411_User
)
...
AGENT_TYPE_TO_FACTORY: dict[RoleImplType, Callable[..., BaseRole]] = {
    ...
    RoleImplType.GPT_4_o: GPT_4_o_Agent,
    RoleImplType.GPT_4_o_mini: GPT_4_o_mini_Agent,
    RoleImplType.GPT_5: GPT_5_Agent,
    RoleImplType.Mistral_Nemo: Mistral_Nemo_Agent,
    RoleImplType.Mistral_Large_2411: Mistral_Large_2411_Agent,
...
USER_TYPE_TO_FACTORY: dict[RoleImplType, Callable[..., BaseRole]] = {
    ...
    RoleImplType.GPT_4_o: GPT_4_o_User,
    RoleImplType.GPT_4_o_mini: GPT_4_o_mini_User,
    RoleImplType.GPT_5: GPT_5_User,
    RoleImplType.Mistral_Nemo: Mistral_Nemo_User,
    RoleImplType.Mistral_Large_2411: Mistral_Large_2411_User,
