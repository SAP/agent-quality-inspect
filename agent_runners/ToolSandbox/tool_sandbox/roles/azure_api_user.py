...
"""Simulated user role for any model that conforms to Azure OpenAI tool use API"""
...
class AzureOpenAPIUser(BaseRole):
    """Simulated user role for any model that conforms to Azure OpenAI tool use API"""
